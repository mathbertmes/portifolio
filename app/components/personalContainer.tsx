  ...
  return(
    <div className="flex bg-main py-5 xl:py-10 px-5 max-h-fit rounded-2xl flex-col">
      ...
      <div className="flex justify-center mt-2 gap-5 w-full xl:border-t xl:mt-8 xl:pt-8">
          ...
          <Link href="https://www.linkedin.com/in/matheus-bertemes-96aa97187/" className="h-8 w-8 xl:h-10 xl:w-10 flex items-center justify-center rounded-full border border-gray-400">
          <TiSocialLinkedin size={20}/>
          </Link>
         
      
          <Link href="https://github.com/mathbertmes" className="h-8 w-8 xl:h-10 xl:w-10 flex items-center justify-center rounded-full border border-gray-400">
        <FiGithub size={20}/>
        </Link>
        <Link href="https://wa.me/16043689869" className="h-8 w-8 xl:h-10 xl:w-10 flex items-center justify-center rounded-full border border-gray-400">
        <FaWhatsapp size={20}/>
        </Link>
      </div>
